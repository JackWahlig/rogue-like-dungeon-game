...
class object {
 ...
 public:
  ...
  object(const std::string &name, const std::string &description, object_type_t type, uint32_t color, pair_t p, const dice &damage,
  ...
  inline void set_value(int32_t v) { value = v; }
